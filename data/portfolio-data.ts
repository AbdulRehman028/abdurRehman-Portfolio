...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Learn AI step by step (ML → DL → NLP → CV → Full Stack AI) Build real projects (not toy examples) Share everything openly for developers & learners, Help Lerners to build small starting Projects.",
    longDescription: "",
    tags: ["AI", "Deep Learning", "OpenAI", "Machine Learning", "NLP", "Hugging Face"],
    image: "/Gemini_Ge.png",
    liveUrl: "",
    githubUrl: "https://github.com/AbdulRehman028/100-days-of-ai",
    featured: true,
    category: "AI",
  },
  {
